...
class BollingerBandsAnalyzer:
    ...
    def plot_bollinger_bands(self, dates, closing_prices, sma20, upper_band, lower_band, signals):
        ...
        plt.figure(figsize=(8,5))  # Grafik boyutunu sabitliyoruz
        ...
        plt.tight_layout()  # Grafiklerin kenarlarını sıkıştır
        plt.show()

    signal = 0

    def analyze(self, plot_graph=True):
        """Veri çekme, hesaplama ve isteğe bağlı grafik işlemlerini başlatır."""
